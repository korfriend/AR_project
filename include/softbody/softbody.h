...
{
	btVector4 v0(v0_.x(), v0_.y(), v0_.z(), 1);
	btVector4 v1(v1_.x(), v1_.y(), v1_.z(), 1);
	btVector4 v2(v2_.x(), v2_.y(), v2_.z(), 1);
	btVector4 v3(v3_.x(), v3_.y(), v3_.z(), 1);
	btVector4 p0(p0_.x(), p0_.y(), p0_.z(), 1);
